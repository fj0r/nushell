...
export alias kgs = kube-get service
export alias kes = kube-edit service
export alias kdels = kube-delete service
export alias kgd = kube-get deployment
export alias ked = kube-edit deployment
